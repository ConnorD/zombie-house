...
public class Tile
{
  ...
  {
    if(xCord +1 < house.length)     { if( house[xCord +1][yCord].isFloor() ) { neighbors.add(house[xCord +1][yCord]); } }
    if(yCord +1 < house[0].length)  { if( house[xCord][yCord +1].isFloor() ) { neighbors.add(house[xCord][yCord +1]); } }
    if(yCord -1 >= 0)               { if( house[xCord][yCord -1].isFloor() ) { neighbors.add(house[xCord][yCord -1]); } }
    if(xCord -1 >= 0)               { if( house[xCord -1][yCord].isFloor() ) { neighbors.add(house[xCord -1][yCord]); } }
  }
  ...
  public double getXCor() { return xCord; }
	  
  public double getYCor() { return yCord; }
